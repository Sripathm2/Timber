...
import emotionsample.MainActivityface;
import naman14.timber.MainActivitystream;
import naman14.timber.StreamYoutube;
    ...
    private void updatePosition(final MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_help:
                ...
                Uri data = Uri.parse("mailto:Sripathm2@gmail.com");
                intent.setData(data);
            ...
            case R.id.nav_stream: {
                Intent i = new Intent(this, MainActivitystream.class);
                startActivity(i);
                break;
            }
            case R.id.Radio: {
                Intent i = new Intent(this, StreamYoutube.class);
                startActivity(i);
                break;
            }
            case R.id.play: {
                Intent i = new Intent(this, MainActivityface.class);
                System.out.print("cgecklmtkdnyd------------------");
                startActivity(i);
                break;
            }
        }
